...
namespace wContourDemo
{
    ...
    {        
        ...
        public void SetCoordinate(double minX, double maxX, double minY, double maxY)
        {
            ...
            _minY = minY;
            _maxY = maxY;            
            _scaleX = this.PictureBox1.Width / (_maxX - _minX);
            _scaleY = this.PictureBox1.Height / (_maxY - _minY);
        ...
        {
            _highlightIdx = int.Parse(TB_Hightlight.Text);
            this.PictureBox1.Refresh();
        }
        ...
        {
            TB_Hightlight.Enabled = ChB_Highlight.Checked;
            PictureBox1.Refresh();
        }
        ...
        private void TSMI_Test_Click(object sender, EventArgs e)
        {
            ...
            ClearObjects();
            _dFormat = "0.0";            
            string dataFile = Application.StartupPath + "\\test1.grd";
            ReadSuferGridData(dataFile);
           ...
           //ClipPolygons();
            ...
            CB_GridData.Checked = false;
            CB_BorderLines.Checked = false;
            CB_ContourLine.Checked = true;
            CB_ContourPolygon.Checked = false;

            SetCoordinate(-10, frmMain.pCurrenWin.PictureBox1.Width, -10, frmMain.pCurrenWin.PictureBox1.Height);
            CreateLegend();
